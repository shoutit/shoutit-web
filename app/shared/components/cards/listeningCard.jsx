        ...
        if(isNotShoutPage && isNotSearchPage && isNotTagProfile) {
            ...
            return (
                <section className="si-card gray-card" style={{overflow: "visible"}}>
                    ...
                    <Grid fluid={true} onMouseEnter={this.mouseEnterHandle(1)} onMouseLeave={this.mouseLeaveHandle(1)}>
                        <Column fluid={true} clear={true} size="3" className="card-list-img">
                    ...
                    <Grid fluid={true} onMouseEnter={this.mouseEnterHandle(2)} onMouseLeave={this.mouseLeaveHandle(2)}>
                        <Column fluid={true} clear={true} size="3" className="card-list-img">
                            <UserImage type="circle" size="26" className="pull-left" image={userImg} />
                        </Column>
                        <Column fluid={true} size="12" className="card-list-item">
