...
describe('DateUtils', () => {
  describe('formatCreatedAt', () => {
    ...
    it('should format correctly dates within the same day', () => {
    ...
    it('should format correctly dates within the same week', () => {
    ...
    it('should format correctly dates within the same year', () => {
    ...
    it('should format correctly dates within the last years', () => {
      const now = moment('2015-12-24 22:00'); // Thursday
  ...
  describe('getUnixTime', () => {
    it('should return the correct unix time', () => {
      expect(DateUtils.getUnixTime(new Date(2016, 3, 7, 12, 10))).to.equal(1460023800);
    });
  });
